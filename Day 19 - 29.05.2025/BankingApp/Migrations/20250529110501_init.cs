        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccountHolders_AccountDetails_AccountDetailId",
                        column: x => x.AccountDetailId,
                        principalTable: "AccountDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountHolders_Addresses_AddressId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountHolders_AccountDetailId",
                table: "AccountHolders",
                column: "AccountDetailId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AccountHolders_AddressId",
                table: "AccountHolders",
                column: "AddressId",
                unique: true);
        }
